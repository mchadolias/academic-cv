...
\resumeSubHeadingListStart
      \resumeSubheading
      {ANTARES-KM3NeT Analysis Meeting}
      {Oct 2025}{Participant (Remote)}{CERN, CH}
      ...
      \resumeSubheading
      {DPG Spring Meeting}
      {Mar 2024}{Speaker: Feasibility study of tau appearance measurement with the ANTARES neutrino telescope (T 29.2)}{Karlsruhe, DE}
      ...
      \resumeSubheading
      {KM3NeT Bootcamp}
      {Oct 2023}{Participant (Remote)}{Paris, FR}
      
      \resumeSubheading
      {GraphNeT III - Workshop}
      {May 2023}{Participant}{Sandvig, DK}
