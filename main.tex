  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Master Thesis Student}{Aug 2023 \textbf{--} Oct 2024, Full-time}
        \resumeItemListStart
            \resumeItem{Conducted the first feasibility study on tau neutrino appearance using ANTARES legacy data, evaluating the reconstruction quality of the events and providing the first estimation of the detector’s capabilities.}
            \resumeItem{Developed a scalable pipeline to convert over 500k ANTARES Monte Carlo event files to TTree-based ROOT files, reducing pre-processing time by 20\%, storage requirements by 35\%, and enabling parallelized cluster execution (NHR@FAU \& CC@Lyon).}
            \resumeItem{Analyzed 200+ different oscillation scenarios via SWIM, taking into consideration the possible cut selection criteria, model parameters, and systematic uncertainties.}
            \resumeItem{Compared ANTARES tau appearance potential against KM3NeT/ORCA predicted sensitivities}
        \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Research Assistant}{Nov 2022 \textbf{--} Apr 2023, Part-time}
        \resumeItemListStart
            \resumeItem{Developed and tested modules within a Snakemake-based MC production pipeline for ORCA events, enabling streamlined batch generation.}
            ...
            \resumeItem{Achieved 25\% CPU workload reduction by improving the SLURM profile, identifying inefficient parallelization patterns, and optimizing Snakemake rule resources.}
        \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Undergraduate Research Assistant}{Nov 2021 \textbf{--} Jan 2022, Internship}
        \resumeItemListStart
            ...
            %\resumeItem{Quantified the error in the reconstruction resolution for events above 100 GeV due to the size of the detector}
    ...
    \resumeSubheading
      ...
      {Space Environment Analyst - Coordinator of the Trajectory Subsystem}{Mar 2019 \textbf{--} Dec 2021, Part-time}
        \resumeItemListStart
            \resumeItem{Led the trajectory subsystem and co-authored proposal preparation for ESA evaluation, contributing to satellite mission approval until the conclusion of a radiation test campaign.}
            \resumeItem{Modeled the space environment for the mission with OMERE, SPENVIS, and estimated the expected total ionized dose during the entire length of the mission with the FASTRAD software, as part of my bachelor's thesis.}
            \resumeItemListEnd
  \resumeSubHeadingListEnd
...
\section{Volunteering}
    ...
    \resumeSubheading
      ...
      {Group coordinator}{Nov 2017 \textbf{--} Jun 2019}
        \resumeItemListStart
            \resumeItem{Organized speaker lists and conference logistics to showcase undergraduate physics research for the second iteration of the $\Sigma\Pi E\Phi$ conference.}
            \resumeItem{Facilitated student visits to research labs, enhancing academic engagement.}
    \resumeItemListEnd    
    % \resumeSubheading
